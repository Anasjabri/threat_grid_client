...
module ThreatGridClient
  # This class is a modified version of RestClient::Request and depends on RestClient
  #
  ...
  class Stream
    ...
    def initialize args
      ...
      @payload = RestClient::Payload.generate(args[:payload])
      @user = args[:user]
    ...
    def transmit uri, req, payload, & block
      ...
      net.start do |http|
        if @block_response
          ...
          res = http.request(req, payload ? payload.to_s : nil) { |http_response| fetch_body(http_response, &block) }
          #log_response res
        end
      end
    ...
    def stringify_headers headers
      headers.inject({}) do |result, (key, value)|
        ...
        if 'CONTENT-TYPE' == key.upcase
          ...
          result[key] = MIME::Types.type_for target_value
          ...
          result[key] = target_values.map { |ext| MIME::Types.type_for(ext.to_s.strip) }.join(', ')
        else
